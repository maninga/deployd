...
var propertyTypes = [
      {
        ...
        , tooltipTitle: "True or false"
          ...
          id: 'date'
        , label: 'date'
        , tooltip: "Add a date property. If the incoming value is not 'a parseable date for date.js' it will be rejected."
        , tooltipTitle: "a parseable date string for moment.js (ISO String) or date.js (humane sentence like 2 days ago at 6pm)"
      }, {
          id: 'object'
        , label: 'object'
        ...
        , tooltipTitle: "JSON Array"
          ...
          id: 'function'
        , label: 'function'
        , tooltip: "Add a javascript function property. If the incoming value is not a valid function it will be rejected (todo)."
        , tooltipTitle: "javascript function definition"
      }
    ];
...
function createPropertyViewModel(data, contextToAdd) {
  ...
  var types = ['string', 'number', 'boolean', 'date', 'object', 'array', 'function' ];
